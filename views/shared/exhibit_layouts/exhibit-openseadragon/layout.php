				...
				<div class="tab-content">
					...
					<?php foreach ($attachments as $attachment): ?>
						...
						<div role="tabpanel" class="tab-pane fade in active" id="tab<?php echo $id; ?>">
							...
							<div class="caption">
								<small><?php echo $caption; ?></small>
                <span class="glyphicon glyphicon-info-sign" aria-hidden="true" data-toggle="popover" data-placement="top" title="<?php echo metadata($item, array('Dublin Core', 'Title')); ?>" data-content="<?php echo link_to_item('View full record', $props = array(), $action = 'show', $item); ?>"></span>
							</div>
							<?php endif; ?>
						</div>
						<?php else: ?>
